...
# I believe that the value None means that the icon is not loaded into the dataset, however, I do not know what the 
# difference is between not including it in icons_selected at all and giving it the value None.
