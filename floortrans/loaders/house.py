...
rooms_selected = data_rooms['rooms_selected']
room_name_map = data_rooms['room_name_map']

all_icons = data_icons['all_icons']
icons_selected = data_icons['icons_selected']
icon_name_map = data_icons['icon_name_map']
